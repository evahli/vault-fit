    ...
    <footer className="max-w-3xl mx-auto px-4 py-12">
      <div className="flex flex-col md:flex-row md:justify-evenly">
        <div>
          ...
          <a className="flex items-center gap-2 text-text hover:text-gold-light whitespace-nowrap"
          ...
          <p className="flex items-center gap-2 text-text hover:text-gold-light whitespace-nowrap"> <Clock className="w-5 h-5" /> Every day 6am - 11:55pm</p>
        ...
        <div>
          ...
          <Link
            to="/terms"
            className="text-text-text hover:text-gold-light transition-colors"
          >
            Terms & Conditions
          </Link>
