  ...
  return (
    <>
      <div className="w-full max-w-xs mx-auto">
        <Carousel>
          <CarouselContent>
            <CarouselItem> <div className="p-4 space-y-2 bg-gray-200 rounded">Slide 1</div> </CarouselItem>
            <CarouselItem> <div className="p-4 bg-gray-200 rounded">Slide 2</div> </CarouselItem>
            <CarouselItem> <div className="p-4 bg-gray-200 rounded">Slide 3</div> </CarouselItem>
          </CarouselContent>
